...
public class NetappDemoActivityUsingAsyncTask extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		button.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				RetrieveFromNetworkTask task = new RetrieveFromNetworkTask();
				task.execute();
			}
		});
	...
	private String readFeedAsJsonStringUsingURL() {
	...
	private String retrieveFeedAsJsonStringUsingHttpClient() {
	...
	private String parseJsonStringToMessage(String jsonString ) {
		String message = "";
		try {
	...
	/*----------------------------------------------------------------------------*/
	class RetrieveFromNetworkTask extends AsyncTask<Void,Void,String> {
		...
		protected String doInBackground(Void... arg0) {
			String jsonString = retrieveFeedAsJsonStringUsingHttpClient();
			//String jsonString = readFeedAsJsonStringUsingURL();
			
			if((jsonString == null) || (jsonString.trim().length() == 0)){
				return "No feed from network!";
			}
			
			String message = parseJsonStringToMessage(jsonString);
			return message;
		}
	}
}